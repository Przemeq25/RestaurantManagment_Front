...
export const restaurantConstants = {
    ...
    GET_OPENING_HOURS_FOR_SELECTED:"GET_OPENING_HOURS_FOR_SELECTED",
    SET_USER_ROLE:"SET_USER_ROLE",
    PAYMENT_REQUESTING: 'PAYMENT_REQUESTING',
...
export const ordersConstants = {
    ...
    GET_ORDERS_ERROR: 'GER_ORDERS_ERROR',
    SWITCH_ORDER_STATUS: 'SWITCH_ORDER_STATUS',
    CHECK_MEAL:"CHECK_MEAL",
    CHECK_ALL_MEALS:"CHECK_ALL_MEALS",
    MOVE_ORDER_TO_NEXT_STATUS:"MOVE_ORDER_TO_NEXT_STATUS",
    REQUESTING:'REQUESTING',
    CHANGE_ORDER_PAY_STATUS:"CHANGE_ORDER_PAY_STATUS",
    ...
    COUNT_TOTAL_PRICE:'COUNT_TOTAL_PRICE',
    INCREMENT_PRODUCT_IN_ORDER:'INCREMENT_PRODUCT_IN_ORDER',
    DECREMENT_PRODUCT_IN_ORDER:"DECREMENT_PRODUCT_IN_ORDER",
    SUBMIT_ORDER_SUCCESS:"SUBMIT_ORDER_SUCCESS",
    SUBMIT_ORDER_ERROR:"SUBMIT_ORDER_ERROR",
    CHANGE_ORDER_COMMENT:"CHANGE_ORDER_COMMENT",
    TOGGLE_ADD_ORDER_MENU: "TOGGLE_ADD_ORDER_MENU",
}
...
export const tablesConstants = {
    ...
    ADD_TABLES_REQUEST: "ADD_TABLES_REQUEST",
    ADD_TABLES_SUCCESS: "ADD_TABLES_SUCCESS",
    ADD_TABLES_ERROR: "ADD_TABLES_ERROR",
    FORM_ADD_TABLE:"FORM_ADD_TABLE",
    FORM_REMOVE_TABLE:"FORM_REMOVE_TABLE",
    FORM_CHANGE_NUMBER_OF_SEATS:"FORM_CHANGE_NUMBER_OF_SEATS",
    FORM_CHANGE_NUMBER_OF_TABLES:"FORM_CHANGE_NUMBER_OF_TABLES",
    FORM_TOGGLE_COLLAPSE:"FORM_TOGGLE_COLLAPSE",
    FORM_TOGGLE_OPEN:"FORM_TOGGLE_OPEN",
    FORM_CHANGE_NAME_OF_TABLE:"FORM_CHANGE_NAME_OF_TABLE",
}
export const reservationsConstants = {
    TOGGLE_RESERVATION_DIALOG: "TOGGLE_RESERVATION_DIALOG",
